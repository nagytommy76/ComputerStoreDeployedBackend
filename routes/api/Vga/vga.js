...
const BaseRatingController_1 = __importDefault(
   require('../../../controllers/Products/Ratings/BaseRatingController')
)
...
router.post(
   '/rate-vga',
   AuthenticateAccessOrRefreshTokens_1.authenticateAccessToken,
   BaseRating.rateProductController
)
router.post(
   '/vga-comment-like',
   AuthenticateAccessOrRefreshTokens_1.authenticateAccessToken,
   BaseRating.likeDislikeCommentController
)
router.delete(
   '/vga-comment-remove',
   AuthenticateAccessOrRefreshTokens_1.authenticateAccessToken,
   BaseRating.removeUsersRatingController
)
// Rating Answers
router.post(
   '/save-vga-answer',
   AuthenticateAccessOrRefreshTokens_1.authenticateAccessToken,
   BaseRating.saveAnswerController
)
router.delete(
   '/vga-answer-remove',
   AuthenticateAccessOrRefreshTokens_1.authenticateAccessToken,
   BaseRating.removeSingleCommentAnswer
)
